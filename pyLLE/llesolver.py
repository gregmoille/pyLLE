...
class LLEsovler(object):
    ...
    **res <dict>**
        ...
        - dispfile <str> : str pointing to a .txt file where the azimuthal mode orders and corresponding resonances are saved and separated by a coma
    ...
    **debug <bool>**: Save a trace in a log file of the different actions pyLLE perform (default = True)
    '''
    _c0 = 299792458
    ...
    def Analyze(self, plot=False, f=None, ax=None, label=None, plottype='all', zero_lines = True, mu_sim = None):
        '''
        Call pyLLE.analyzedisp.AnalyzeDisp to get the dispersion of the resonator
        '''
    ...
    def SolveTemporal(self, tol = 1e-3, maxiter = 6, step_factor = 0.1):
        ...
        The subprocess.Popen is saved in the attribute self.JuliaSolver
        '''
    ...
    def PlotCombPower(self, do_matplotlib = False):
        ...
        **Output**
            ...
            - if jupyter notebook:
                - fig:  handle of figure and axes of the plotly figure displayed
            - if ipython or script:
    ...
    def PlotCombSpectra(self, ind, f=None, ax=None, label=None, pwr='both', do_matplotlib = False, plot = True):
        ...
        It save the corresponding spectra in the attribute **self.spectra**
    ...
    def PlotSolitonTime(self, ind, f=None, ax=None, label=None, do_matplotlib = False):
        '''
        Plot the temporal profile for a given index in the 1000 sub-sampled LLE step 

        It save the corresponding time profile in the attribute **self.fasttime**
    ...
    def SavePlots2File(self,basename = './', format = 'pdf'):
        '''
        Save the different figures in the corresponding format with matplotlib and the previous class Latexify. It will only save the figure of the type of plot displayed earlier
        The name of the file are automatically created depending of the plot
    
        **Input**

            - basename <str>: basename of the file. It can include a path too
            - format <str>: format to save the figure. Has to be compatible with matplotlib
        '''
